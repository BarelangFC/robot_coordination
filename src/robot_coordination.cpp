...
std::string SERVER1_string;  //IP robot 1
std::string SERVER2_string;  //IP robot 2
std::string SERVER3_string;  //IP robot 3
std::string SERVER4_string;  //IP robot 4
std::string SERVER5_string;  //IP robot 5
...
rclcpp::Publisher<bfc_msgs::msg::Coordination>::SharedPtr robotCoordination_1;
rclcpp::Publisher<bfc_msgs::msg::Coordination>::SharedPtr robotCoordination_2;
rclcpp::Publisher<bfc_msgs::msg::Coordination>::SharedPtr robotCoordination_3;
rclcpp::Publisher<bfc_msgs::msg::Coordination>::SharedPtr robotCoordination_4;
rclcpp::Publisher<bfc_msgs::msg::Coordination>::SharedPtr robotCoordination_5;
rclcpp::Subscription<bfc_msgs::msg::Coordination>::SharedPtr recvSub_;
...
void RobotCoordination::readRobotCoordinationData1() {
    ...
    msg.robot_number = robot1Id;
    msg.status = robot1Status;
    msg.state = robot1State;
    msg.grid_position = robot1GridPosition;
    msg.found_ball = robot1FBall;
    msg.distance_ball = robot1DBall;
    msg.grid_ball = robot1GridBall;
    msg.back_in = robot1BackIn;
    robotCoordination_1->publish(msg);
}
...
void RobotCoordination::readRobotCoordinationData2() {
    ...
    auto msg = bfc_msgs::msg::Coordination();
    msg.robot_number = robot2Id;
    msg.status = robot2Status;
    msg.state = robot2State;
    msg.grid_position = robot2GridPosition;
    msg.found_ball = robot2FBall;
    msg.distance_ball = robot2DBall;
    msg.grid_ball = robot2GridBall;
    msg.back_in = robot2BackIn;
    robotCoordination_2->publish(msg);
}
void RobotCoordination::readRobotCoordinationData3() {
    ...
    auto msg = bfc_msgs::msg::Coordination();
    msg.robot_number = robot3Id;
    msg.status = robot3Status;
    msg.state = robot3State;
    msg.grid_position = robot3GridPosition;
    msg.found_ball = robot3FBall;
    msg.distance_ball = robot3DBall;
    msg.grid_ball = robot3GridBall;
    msg.back_in = robot3BackIn;
    robotCoordination_3->publish(msg);
}
...
void RobotCoordination::readRobotCoordinationData4() {
    ...
    auto msg = bfc_msgs::msg::Coordination();
    msg.robot_number = robot4Id;
    msg.status = robot4Status;
    msg.state = robot4State;
    msg.grid_position = robot4GridPosition;
    msg.found_ball = robot4FBall;
    msg.distance_ball = robot4DBall;
    msg.grid_ball = robot4GridBall;
    msg.back_in = robot4BackIn;
    robotCoordination_4->publish(msg);
}
...
void RobotCoordination::readRobotCoordinationData5() {
    ...
    auto msg = bfc_msgs::msg::Coordination();
    msg.robot_number = robot5Id;
    msg.status = robot5Status;
    msg.state = robot5State;
    msg.grid_position = robot5GridPosition;
    msg.found_ball = robot5FBall;
    msg.distance_ball = robot5DBall;
    msg.grid_ball = robot5GridBall;
    msg.back_in = robot5BackIn;
    robotCoordination_5->publish(msg);
}
...
void callbackCoordination(const bfc_msgs::msg::Coordination::SharedPtr message)
{
    koordinasi.sendRobotCoordinationData(message->robot_number, message->status, message->state, message->grid_position, message->found_ball, message->distance_ball, message->grid_ball, message->back_in);
}
...
int main(int argc, char **argv)
{
    ...
    auto node = std::make_shared<rclcpp::Node>("robot_coordination",rclcpp::NodeOptions().use_intra_process_comms(true));
    node->declare_parameter("RobotID", 0);
	node->declare_parameter("SERVER1", "");
	node->declare_parameter("SERVER2", "");
	node->declare_parameter("SERVER3", "");
	node->declare_parameter("SERVER4", "");
	node->declare_parameter("SERVER5", "");
    koordinasi.RobotID = node->get_parameter("RobotID").as_int();
	SERVER1_string = node->get_parameter("SERVER1").as_string();
	SERVER1 = SERVER1_string.c_str();
	SERVER2_string = node->get_parameter("SERVER2").as_string();
	SERVER2 = SERVER2_string.c_str();
	SERVER3_string = node->get_parameter("SERVER3").as_string();
	SERVER3 = SERVER3_string.c_str();
	SERVER4_string = node->get_parameter("SERVER4").as_string();
	SERVER4 = SERVER4_string.c_str();
	SERVER5_string = node->get_parameter("SERVER5").as_string();
	SERVER5 = SERVER5_string.c_str();
    if (koordinasi.RobotID != 1)
        robotCoordination_1 = node->create_publisher<bfc_msgs::msg::Coordination>("/robot_1/coordination", 1);
    if (koordinasi.RobotID != 2)
        robotCoordination_2 = node->create_publisher<bfc_msgs::msg::Coordination>("/robot_2/coordination", 1);
    if (koordinasi.RobotID != 3)
        robotCoordination_3 = node->create_publisher<bfc_msgs::msg::Coordination>("/robot_3/coordination", 1);
    if (koordinasi.RobotID != 4)
        robotCoordination_4 = node->create_publisher<bfc_msgs::msg::Coordination>("/robot_4/coordination", 1);
    if (koordinasi.RobotID != 5)
        robotCoordination_5 = node->create_publisher<bfc_msgs::msg::Coordination>("/robot_5/coordination", 1);
    recvSub_ = node->create_subscription<bfc_msgs::msg::Coordination>("coordination", 1, callbackCoordination);
    koordinasi.initCommunicationIn();
    koordinasi.initCommunicationOut();
    timer_ = node->create_wall_timer(
    std::chrono::milliseconds(40), timerCallBack);
    rclcpp::spin(node);
    rclcpp::shutdown();
    return 0;
}